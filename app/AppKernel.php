...
use Cjw\PublishToolsBundle\CjwPublishToolsBundle;
...
class AppKernel extends Kernel
{
    ...
    public function registerBundles(): iterable
    {
        ...
        $bundles[] = new Cjw\FieldTypesBundle\CjwFieldTypesBundle();

        $bundles[] = new CJW\CJWConfigProcessor\CJWConfigProcessorBundle();
        $bundles[] = new Cjw\NetgenLayoutsExtendedBundle\NetgenLayoutsExtendedBundle();
        $bundles[] = new Cjw\TmvBundle\TmvBundle();
