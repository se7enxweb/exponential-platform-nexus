...
/**
 * FileStreamService is a helper Class to Stream a file
 *
 * inspired by author Rana
...
class FileStreamService
{
    ...
    /**
     * CjwFileStream constructor.
     *
     * @param $file  object or path of file
     */
    ...
    private function setHeader ()
    {
        ...
        header( 'Content-Disposition: ' . $this->contentDisposition . '; filename=' . urlencode( $this->fileName ) );
