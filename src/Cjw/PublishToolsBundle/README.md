...
| filter_tags | array | not set | no | limits fetch to results with an array of tag ids |
| filter_search | array | not set | no | ToDo: not implemented yet |
| filter_attribute | array | not set | no | ToDo: not implemented yet |
| custom_criterion | array | not set | no | @see example: src/Cjw/PublishToolsBundle/PublishToolsService/CustomCriterion/FlowBlockType.php |
