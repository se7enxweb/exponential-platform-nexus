 ...
 *
 */
class TwigConfigFunctionsService extends \Twig\Extension\AbstractExtension implements \Twig\Extension\GlobalsInterface
{
    ...
    {
        // Expose site access aware configuration parameters as global twig variables
        $cjwSiteAccessValues = $this->siteAccessParameters();
        return array(
            'cjw_siteaccess' => $cjwSiteAccessValues
        );
    }
