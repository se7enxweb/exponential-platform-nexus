...
namespace Cjw\NetgenLayoutsExtendedBundle\DependencyInjection;
...
final class NetgenLayoutsExtendedExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritDoc}
     */
    ...
    public function prepend(ContainerBuilder $container): void
    {
        ...
        $prependConfigs = [
            ...
            'block_view.yaml'        => 'netgen_layouts'
        ];
        ...
        $configFile = __DIR__ . '/../Resources/config/content_view.yaml';
