...
--
-- Table structure for table `cjwnl_blacklist_item`
--

DROP TABLE IF EXISTS `cjwnl_blacklist_item`;
...
--
-- Table structure for table `cjwnl_edition`
--

DROP TABLE IF EXISTS `cjwnl_edition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cjwnl_edition_send`
--

DROP TABLE IF EXISTS `cjwnl_edition_send`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cjwnl_edition_send` (
  ...
  `mailqueue_process_scheduled` int(11) DEFAULT NULL,
...
--
-- Table structure for table `cjwnl_edition_send_item`
--

DROP TABLE IF EXISTS `cjwnl_edition_send_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cjwnl_import`
--

DROP TABLE IF EXISTS `cjwnl_import`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cjwnl_list`
--

DROP TABLE IF EXISTS `cjwnl_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cjwnl_list` (
  ...
  `user_data_fields` mediumtext NOT NULL COMMENT 'definition user data fields for data input ( show / required ) as xml',
  `is_virtual` tinyint(1) NOT NULL DEFAULT 0,
  `virtual_filter` mediumtext NOT NULL,
  PRIMARY KEY (`contentobject_attribute_id`,`contentobject_attribute_version`),
  KEY `contentobject_id` (`contentobject_id`),
  KEY `contentobject_attribute_id` (`contentobject_attribute_id`),
  KEY `contentobject_attribute_version` (`contentobject_attribute_version`)
...
--
-- Table structure for table `cjwnl_mailbox`
--

DROP TABLE IF EXISTS `cjwnl_mailbox`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cjwnl_mailbox_item`
--

DROP TABLE IF EXISTS `cjwnl_mailbox_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cjwnl_subscription`
--

DROP TABLE IF EXISTS `cjwnl_subscription`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `cjwnl_user`
--

DROP TABLE IF EXISTS `cjwnl_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cjwnl_user` (
  ...
  `data_xml` mediumtext DEFAULT NULL COMMENT 'extra data kodiert in xml',
  ...
  `data_text` mediumtext DEFAULT NULL COMMENT 'field is free for any kind of text data',
  `custom_data_text_1` varchar(255) NOT NULL,
  `custom_data_text_2` varchar(255) NOT NULL,
  `custom_data_text_3` varchar(255) NOT NULL,
  `custom_data_text_4` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ezsearch_object_word_link` (
  ...
  `language_mask` bigint(20) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
